  ...
  <form action="" method="POST">
    ...
    <div class="form-content">
      ...
      <div class="form-item">
        ...
        <ul>
          <li>
            <input class="input-radio" type="radio" id="radioMale" name="sex" value="male" checked>
            <label for="radioMale">Мужчина</label>
          </li>
          <li>
            <input class="input-radio" type="radio" id="radioFemale" name="sex" value="female">
      ...
      <div class="form-item">
        ...
        <ul>
          <li>
            <input class="input-radio"  type="radio" id="radioRight" name="hand" value="right" checked>
            <label for="radioRight">Правша</label>
          </li>
          <li>
            <input class="input-radio"  type="radio" id="radioLeft" name="hand" value="left">
